...
Most production work is under NDA.  OpsCore below is a demo built to show the kin d of systems I work on day to day.

**Safety  Straw**
Full-stack build for a seed-stage sta rtup making straws that glow when a drink is  spiked. Stripe-integrated B2C and B2B checkou t, async notification system, and an AI suppo rt agent that resolved 80%+ of customer inqui ries autonomously.
`Node.js` `Express` `Mongo DB` `Stripe` `React`
...
**[Scheduler](https://gith ub.com/stdmitry04/scheduler)**
...
**[Volunteer Matchmaker](https://github.c om/stdmitry04/Volunteer_Matchmaker)**
...
**[CourseChecker](https://github.com/ne ontap/spartahack)**
...
Michigan State University -- B.S. Comput er Science, Business Minor - GPA 3.75 - May 2 026
